...
public class WebSecurityConfig {
    ...
    @Bean
    public SecurityFilterChain applicationSecurity(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        http
                ...
                .authorizeHttpRequests(registry -> registry
                        .requestMatchers("/api/auth/v1/**", "/api/users/signup").permitAll()

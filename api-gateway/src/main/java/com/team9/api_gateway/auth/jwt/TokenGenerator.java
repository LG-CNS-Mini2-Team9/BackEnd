...
public class TokenGenerator {
    ...
    public TokenDto.AccessToken generateAccessToken(String userId, String deviceType) {
        TokenDto.JwtToken jwtToken = generateJwtToken(userId, deviceType, false);
    ...
    public TokenDto.AccessRefreshToken generateAccessRefreshToken(String userId, String deviceType) {
        TokenDto.JwtToken accessJwtToken = generateJwtToken(userId, deviceType, false);
        TokenDto.JwtToken refreshJwtToken = generateJwtToken(userId, deviceType, true);

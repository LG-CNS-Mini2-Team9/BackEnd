...
public class AIQuestionService {
    ...
    public QuestionResponseDto generateCSQuestion(String category, List<String> existingKeywords) throws JsonProcessingException {
    ...
    private String createDetailedPromptWithKeywordExclusion(String category, List<String> existingKeywords) {
        ...
        prompt.append("2. 해당 질문에 대한 힌트를 제공해주세요 (답변에 포함되어야 할 핵심 단어들을 쉼표로 구분)\n");
